...
import org.secure.sms.SecureMessagesActivity;
...
public class DatabaseHandler extends SQLiteOpenHelper {
   ...
   // Adding new contact
    public  void addContact(ContactBean contact)throws Exception{
        SQLiteDatabase db = this.getWritableDatabase();
 
        ContentValues values = new ContentValues();
        values.put(KEY_NAME, contact.getPassword()); // Contact Name
    ...
    ContactBean getContact(int id) {
        ...
        ContactBean contact = new ContactBean(Integer.parseInt(cursor.getString(0)),
